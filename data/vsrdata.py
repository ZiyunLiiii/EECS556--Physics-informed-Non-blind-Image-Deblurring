...
class VSRData(data.Dataset):
    ...
    def _load_file(self, idx):
        ...
        if self.train:
            ...
            sharps = sharps[:, h_offset:h_offset + self.args.patch_size, w_offset:w_offset + self.args.patch_size,:]
            blurs = blurs[:, h_offset:h_offset + self.args.patch_size, w_offset:w_offset + self.args.patch_size,:]
